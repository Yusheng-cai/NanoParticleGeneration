...
# Function that simply builds the test executable which can later on be used multiple times
function(add_test_exe  TEST_SUBDIR TEST_NAME)
  set(options        "")
  set(oneValueArgs  EXE_OUT)
  set(multiValueArgs SOURCES LIBS  INCLUDES  DRIVER  ARGS  MPI_NP  OMP_NT)
  cmake_parse_arguments(PARSE_ARGV 1 "TEST" "${options}" "${oneValueArgs}" "${multiValueArgs}")
